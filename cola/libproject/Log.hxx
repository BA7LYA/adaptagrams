...
Keywords: OCT07   C++
Description: Unpublished source code accompanying the article by Petru
Marginean, in which he presents a C++ logging framework that is typesafe,
...
inline std::string NowTime()
{
    ...
    result << buffer << "." << std::setfill('0') << std::setw(3)
