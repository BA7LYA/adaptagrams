...
#include "libavoid/ClusterRef.hxx"

#include <cstdlib>

#include "libavoid/assertions.hxx"
#include "libavoid/debug.hxx"
...
ClusterRef::~ClusterRef()
{
    ...
    {
        err_printf(
            "ERROR: ClusterRef::~ClusterRef() shouldn't be called directly.\n"
        );
        err_printf(
            "       It is owned by the router.  Call Router::deleteCluster() "
            "instead.\n"
        );
        abort();
    }
...
void ClusterRef::makeActive(void)
{
    ...
    m_clusterrefs_pos
        = m_router->clusterRefs.insert(m_router->clusterRefs.begin(), this);
