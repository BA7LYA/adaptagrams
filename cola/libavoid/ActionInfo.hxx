...
///
/// @brief This class is not intended for public use. It is used internally by
/// Router to track actions performed on objects during transactions.
///
class ActionInfo
{
public:
