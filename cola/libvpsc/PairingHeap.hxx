...
{
#ifndef SWIG
    friend std::ostream& operator<< <T, TCompare>(
        std::ostream&                   os,
 ...
 */
template<class T, class TCompare>
PairNode<T>* PairingHeap<T, TCompare>::insert(const T& x)
{
 ...
 */
template<class T, class TCompare>
const PairingHeap<T, TCompare>& PairingHeap<T, TCompare>::operator=(
 ...
 */
template<class T, class TCompare>
void PairingHeap<T, TCompare>::decreaseKey(PairNode<T>* p, const T& newVal)
{
 ...
 */
template<class T, class TCompare>
void PairingHeap<T, TCompare>::compareAndLink(
    PairNode<T>*& first,
    PairNode<T>*  second
) const
{
 ...
 */
template<class T, class TCompare>
PairNode<T>* PairingHeap<T, TCompare>::combineSiblings(PairNode<T>* firstSibling
)
{
 ...
 */
template<class T, class TCompare>
PairNode<T>* PairingHeap<T, TCompare>::clone(PairNode<T>* t) const
{
    if (t == nullptr)
    {
        return nullptr;
